      ...
      <div className="flex flex-col md:flex-row justify-between w-full gap-10 border-b border-gray-800 pb-14">
        <div className="md:max-w-96">
          ...
          <p className="text-gray-400 text-sm leading-relaxed">
            Experience movies like never before with CineVibe. Your premium
            destination for booking tickets, finding showtimes, and discovering
          ...
          <div className="flex items-center gap-4 mt-6">
            <img
              ...
              className="h-10 w-auto opacity-80 hover:opacity-100 transition duration-300 cursor-pointer"
            />
            <img
              src={assets.appStore}
        ...
        <div className="flex-1 flex items-start md:justify-end gap-20 md:gap-40">
          <div>
            <h2 className="font-semibold text-white mb-5 uppercase tracking-wider text-sm">
              Company
            </h2>
